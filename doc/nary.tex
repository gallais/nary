...
\section{Representating N-ary Function Types}
...
define containers storing them like any other type of values. Our first definition
called \AF{Levels} defines an \AB{n}-tuple of \AF{Level}s by induction on \AB{n}.

\ExecuteMetaData[N-ary.tex]{levels}

\paragraph{Heterogeneous Domains}\todo{}

\ExecuteMetaData[N-ary.tex]{tolevel}
\ExecuteMetaData[N-ary.tex]{sets}

\paragraph{Semantics}\todo{}
