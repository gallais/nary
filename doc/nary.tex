...
\section{Further Generic Programming}
...
Some functions are easier to write curried but easier to use uncurried.
This is the case for instance with \AF{zipWithₙ}.\todo{explain}
