...
list then \AB{P} can't hold of all its elements. In other words:
...
in direct style, recovering the usual type by generic currying. We work in a
...
these we can give \AF{Format} a semantics:
