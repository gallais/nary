...
This encoding has a straightforwrd semantics by induction on \AB{n} and case
...
Casinghino's work~\cite{DBLP:conf/plpv/WeirichC10} on not only arity-generic
but also data-generic programming suggest we may be able to push this further.
Their development predates the addition of universe polymorphism to Agda and
although the traversals are adequately heterogeneous, their approach would
not scale to universe polymorphic functions.
