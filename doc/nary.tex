...
in by using concrete quantifiers. Because we are dealing with \AF{Set}-valued
functions, we can leave their arity as an implicit argument and let Agda infer it
at use site. In all cases we give them the same name as their unary counterparts
as they can be used as drop-in replacements for them.
