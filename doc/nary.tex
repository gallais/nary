...
We write \AB{?a} for a metavariable \AB{a}, and {\AB{lhs} ≈ \AB{rhs}}
for a unification problem between two expressions. \todo{\AB{\_} invokes unif}
