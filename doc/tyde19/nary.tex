...
All the code in this paper is written in Agda; we discuss some of the more
...
two \AF{Set}s introduced implicitly together with their respective universe
levels \AB{a} and \AB{b} (see Appendix~\ref{appendix:agda:level}) and \AB{x}
and \AB{y} are two values of type \AB{A}. All have been introduced using this
...
\AB{l} by writing (\AF{Set} \AB{l}). The prototypical example of such a
level polymorphic function is the identity function \AF{id} defined as follows.
